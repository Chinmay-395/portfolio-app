  ...
  return (
    ...
    >
      <div className="projects__navbar">
        ...
        <div
          className={active === "django" && "projects__navbar-active"}
        ...
        <div
          className={active === "websocket" && "projects__navbar-active"}
          onClick={() => handleFilterCategory("websocket")}
        >
          Web-Sockets
        </div>

        <div
          className={active === "IOT" && "projects__navbar-active"}
          onClick={() => handleFilterCategory("IOT")}
        >
          IOT
        </div>

        <div
          className={active === "WebRTC" && "projects__navbar-active"}
          onClick={() => handleFilterCategory("WebRTC")}
        >
          WebRTC
        </div>
      </div>
